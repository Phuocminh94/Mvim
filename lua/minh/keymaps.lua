...
-------------------------------------------------------------------------------
-- NERDTree
map("n", "<leader>e", "<cmd>NERDTreeToggle %:p:h<CR>", "Toggle File Explorer")
...
map("v", "<leader>s", "<cmd>sort<CR>", "Sort lines")
...
map("n", "<leader>ff", function()
  ...
  .get_ivy(ivy_config), "Find Files")
end)

map("n", "<leader>fo", function()
    require("telescope.builtin").oldfiles(require("telescope.themes")
...
map("n", "<leader>fc", function()
    ...
    get_ivy(vim.tbl_deep_extend("force", ivy_config, {
...
-- SNIPPETS & GIT
-------------------------------------------------------------------------------
map("i", "<C-s>", function() require("luasnip").expand() end, "Expand snippet")

-- Gitsigns
map("n", "]h", function() require("gitsigns").next_hunk() end, "Next git hunk")
map("n", "[h", function() require("gitsigns").prev_hunk() end, "Prev git hunk")
map("n", "<leader>hr", function() require("gitsigns").reset_hunk() end, "Reset git hunk")
map("n", "<leader>hp", function() require("gitsigns").preview_hunk() end, "Preview git hunk")
